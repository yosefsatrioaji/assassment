...
<div class="container mb-4">
    ...
    <div class="row mt-2">
        <div class="col-lg-4 rounded bg-grey p-3">
            ...
            <form action="/practicetwo/update/<?= $tabel->id ?>" method="post">
                <?= csrf_field() ?>
                <div class="mb-3">
                    <label for="kepemilikan" class="form-label" >Nama Kepemilikan</label>
                    <input class="form-control" id="kepemilikan" name="kepemilikan" placeholder="Kepemilikan . . . " value="<?= $tabel->kepemilikan ?>">
                </div>
                <div class="mb-3">
                    <label for="jenis">Jenis Kepemilikan</label>
                    <?php $arrayjenis = explode(",", $tabel->jenis); ?>
                    <div class="form-check ms-2 mt-1 border-top">
                        <input class="form-check-input" type="checkbox" value="usaha" name="jenis[]" <?php if (
                    ...
                    <div class="form-check ms-2 mt-1 border-top">
                        <input class="form-check-input" type="checkbox" value="perorangan" name="jenis[]" <?php if (
                    ...
                    <div class="form-check ms-2 mt-1 border-top">
                        <input class="form-check-input" type="checkbox" value="yayasan" name="jenis[]" <?php if (
